class MovingPipe extends Obstacle {
    constructor({ objectClass, bird, canvasX = 0, height = random(230, Height - 230), speedY = 3, direction = ['up', 'down'][Math.round(random(0, 1))], index = 0, aliveTime = 9999999, x = Width } = {}) {
        super({ bird: bird });
        this.index = index;
