class Popen extends Obstacle {
    constructor({ objectClass, bird, canvasX = 0, height = random(200, Height - 230), open = Boolean(Math.round(random(0, 1))), index = 0, aliveTime = 9999999, x = Width } = {}) { //depth is the HEIGHT of the top pipe!
        super({ bird: bird });
        this.index = index;
        this.name = 'Popen';
